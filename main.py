...
async def send_to_all_groups(msg):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            ...
            InlineKeyboardButton("🧮 Numbers", url="https://t.me/+c4VCxBCT3-QzZGFk"),
        ...
        [
            ...
            InlineKeyboardButton("✅ YouTube", url="https://youtube.com/@junaidniz786?si=tQFOJbg7aDL5XpG7")
                    ...
                    if text.startswith("/start"):
                        ...
                        keyboard = InlineKeyboardMarkup([
                            ...
                            [
                                ...
                                InlineKeyboardButton("💬 Join Group", url="https://t.me/primezone3"),

                                InlineKeyboardButton("📢 Join Channel", url="https://t.me/primeotpzone")

                            ],

                            [

                                InlineKeyboardButton("👨‍💻 Developer", url="https://t.me/NONEXPERTCODER")
...
✅ Bot is working and active!

For more details: @NONEXPERTCODER
...
""",
                    ...
                    # /otpfor command
                        ...
                        if len(parts) < 2:
                            ...
                            await bot.send_message(chat_id=chat_id, text="⚠️ Usage: /otpfor <number>")
                        ...
                        if number in store:
                            ...
                            await bot.send_message(
                                ...
                                text=f"🔐 <b>Saved OTP for {number}:</b> <code>{store[number]}</code> 🔐",
                                ...
                                if data and number in data["number"]:
                                    ...
                                    if otp:
                                        ...
                                        await bot.send_message(
                                            ...
                                            text=f"✅ <b>OTP Found & Saved:</b> <code>{otp}</code> ✅",
                            ...
                            if not found:
                                ...
                                await bot.send_message(chat_id=chat_id, text="❌ <b>No OTP found for this number!</b>", parse_mode="HTML")
