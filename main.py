...
# ================= JOIN CHECK =================
def check_join(uid):
    required_channels = ["@RN_INCOME_TIPS", "@RN_INCOME_TIPS"]
...
def start(m):
    if not check_join(m.chat.id):
        ...
        kb.add(types.InlineKeyboardButton("📢 Join", url="https://t.me/+4mt-ZKLhSRc1YmU1"))
        kb.add(types.InlineKeyboardButton("📢 Join", url="https://t.me/RN_INCOME_TIPS"))
        kb.add(types.InlineKeyboardButton(f"📢 Join", url="https://t.me/+AFDs2BNRUq4yOWY1"))
...
def pick_country(c):
    ...
    if res:
        ...
        kb.add(types.InlineKeyboardButton("📱 OTP Group", url="https://t.me/+AFDs2BNRUq4yOWY1"))
